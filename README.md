...
- **Machine-friendly by design:** use stable ids (persistent anchors reused by search, chat, and deep links), explicit headings, landmarks, labels, captions, and structured metadata so agents and bots can parse the site reliably
